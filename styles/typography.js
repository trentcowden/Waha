 ...
 * )***REMOVED***/>
 * @export
 * @param {Object***REMOVED*** props - The props from the component that calls this function. Notably includes the font name for the active group and whether the active group's language is RTL.
 * @param {string***REMOVED*** fontSize - The size of the font. Can be "d" (for detail), "p" (for paragraph), "h4" (for header 4), "h3" (for header 3), "h2" (for header 2), or "h1" (for header 1).
 * @param {string***REMOVED*** fontFamily - The family, or weight, of the font. Can be "Regular", "Bold", or "Black".
 * @param {string***REMOVED*** textAlign - The alignment of the text. Can be "center" which aligns text center or "left" which aligns text left or right depending on whether we need to be RTL.
 * @param {string***REMOVED*** color - The color of the font. Can be any color for the colors object in ./colors.js.
 * @return {Object***REMOVED*** - The completed style object.
 */
 ...
 * @export
 * @param {boolean***REMOVED*** isHeader - Whether this style object will be used for a header or not.
 * @param {string***REMOVED*** fontSize - The size of the font. Can be "d" (for detail), "p" (for paragraph), "h4" (for header 4), "h3" (for header 3), "h2" (for header 2), or "h1" (for header 1).
 * @param {string***REMOVED*** fontFamily - The family, or weight, of the font. Can be "Regular", "Bold", or "Black".
 * @param {string***REMOVED*** textAlign - The alignment of the text. Can be "center" which aligns text center or "left" which aligns text left or right depending on whether we need to be RTL.
 * @param {string***REMOVED*** color - The color of the font. Can be any color for the colors object in ./colors.js.
 * @param {string***REMOVED*** overrideFont - If we want to override the system language font with the active group's language's font, we can include this parameter.
 * @return {Object***REMOVED*** - The completed style object.
 */
 ...
 * @export
 * @return {string***REMOVED*** - The name of the font to use.
 */

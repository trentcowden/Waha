      ...
      <View style={styles.screen***REMOVED***>
         ...
         <View style={styles.bottomHalfContainer***REMOVED***>
            <View style={styles.inputContainer***REMOVED***>
               <Text style={[styles.groupNameLabel, { textAlign: props.isRTL ? 'right' : 'left' ***REMOVED***]***REMOVED***>{props.translations.labels.groupName***REMOVED***</Text>
               <TextInput
               ...
               <TouchableOpacity
                  ...
                  ***REMOVED***
               >
                  <Text style={[styles.resetProgressButtonText, { textAlign: props.isRTL ? 'right' : 'left' ***REMOVED***]***REMOVED***>{props.translations.labels.resetProgress***REMOVED***</Text>
               </TouchableOpacity>

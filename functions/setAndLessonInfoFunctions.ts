...
const filterBySetCategory = (set: StorySet, category: SetCategory): boolean => {
...
const sortSets = (
  ...
  if (sortType === 'orderAdded') {
    ...
    if (storySet1IDMatches && storySet2IDMatches)
      return parseInt(storySet1IDMatches[0]) - parseInt(storySet2IDMatches[0]) <
        0
        ? -1
        : 1
    else return 1

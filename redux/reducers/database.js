import { STORE_DATA, FETCH_ERROR, SET_IS_FETCHING, SET_FIRST_OPEN, SET_IS_READY_TO_START, DELETE_LANGUAGE, SET_CURRENT_FETCH_PROGRESS ***REMOVED*** from '../actions/databaseActions'

export function database(state = { isFetching: true, isFirstOpen: true, readyToStart: false, currentFetchProgress: 0 ***REMOVED***, action) {
   switch (action.type) {
      case STORE_DATA:
